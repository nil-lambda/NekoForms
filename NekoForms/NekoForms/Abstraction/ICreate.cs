...
namespace NekoForms.Abstraction
{
    ...
    interface ICreate
    {
        ...
        /// <param name="dynamicChecked">Parameter expects boolean value that will determine whether or not the parsed CheckBox is checked or not.</param>
        /// <param name="fixedChecked">Parameter expects boolean value that will determine whether or not the parsed CheckBox is checked or not.</param>
        void CreateFormProperties(ref Form _form, string subFolder, int fixedWidth, int fixedHeight, bool dynamicChecked, bool fixedChecked);
        /// <summary>
